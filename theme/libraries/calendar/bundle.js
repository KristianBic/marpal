...
if ($("#active_lang").length) {
  switch ($("#active_lang").data("lang")) {
    case "sk":
      longLowerWeek = ["Ned", "Pon", "Uto", "Str", "Štv", "Pia", "Sob"];
      longUpperWeek = ["NED", "PON", "UTO", "STR", "ŠTV", "PIA", "SOB"];
      shortWeek = ["N", "P", "U", "S", "Š", "P", "S"];
      monthsShort = [
        "Január",
        "Február",
        "Marec",
      ...
      break;
    case "de":
      longLowerWeek = ["Son", "Mon", "Die", "Mit", "Don", "Fre", "Sam"];
      longUpperWeek = ["SON", "MON", "DIE", "MIT", "DON", "FRE", "SAM"];
      shortWeek = ["S", "M", "D", "M", "D", "F", "S"];
      monthsShort = [
        "Januar",
        "Februar",
        "März",
      ...
      break;
    default:
      longLowerWeek = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
      longUpperWeek = ["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"];
      shortWeek = ["S", "M", "T", "W", "T", "F", "S"];
      monthsShort = [
        "January",
        "February",
        "March",
    ...
    constructor(e = {}) {
      ...
      if (
        ...
        (this.weekdayDisplayTypeOptions = {
          short: shortWeek,
          "long-lower": longLowerWeek,
          "long-upper": longUpperWeek,
        }),
        ...
        (this.customMonthValues = monthsShort),
