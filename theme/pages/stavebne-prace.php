<div class="body">
            ...
            <div class="hero-backgroundImage">
                <div class="mediaContainer">
                    <video class="hero-backgroundImage" autoplay loop muted>
                        <source src="<?php echo BASE_URL; ?>assets/image/videos/hero-stavebne-prace.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
        ...
        <div class="sortiment-container">
            <div class="sortiment-content">
                <div class="sortiment-text-container">
                    <h2>Stavba rodinných domov na kľúč</h2>
                    <p>V rámci našich služieb vieme zabezpečiť kompletnú realizáciu stavby rodinného domu od založenia stavby až po kolaudáciu.</p>
        ...
        <div class="sortiment-container two">
            <div class="sortiment-content two">
                ...
                <div class="sortiment-text-container">
                    ...
                    <p>Zmodernizujeme a zrekonštrujeme <b>všetky typy rodinných domov</b> a <b>administratívnych</b>, či <b>hospodárskych</b> objektov.</p>
                    <a class="button" href="<?php echo BASE_URL; ?>galeria">Projekty</a>
                </div>
            </div>
        </div>
        <div class="sortiment-container three">
            <div class="sortiment-content three">
                <div class="sortiment-text-container">
                    <h2>Realizácia monolitických stavieb</h2>
                    <p>Ponúkame aj realizáciu <b>monolitických stavieb</b> (napr. podzemné garáže, oporné múry, ale aj celé objekty), Monolitické stavby vynikajú nielen moderným dizajnom ale aj výbornými úžitkovými vlastnosťami akými sú vysoká pevnosť, tvárnosť trvanlivosť a odolnosť voči mechanickému poškodeniu</p>
                    <a class="button" href="<?php echo BASE_URL; ?>galeria">Projekty</a>
                </div>
                <div class="sortiment-image">
    ...
    <div class="doplnkove-sluzby">
        <div class="doplnkove-sluzby-container">
            <h3>Doplnkové služby</h3>
            <p>V rámci stavieb ponúkamé taktiež aj tieto doplnkové služby. <b>Služby poskytujeme iba ako celok a nie osobitne!</b></p>
            <div class="doplnkove-sluzby-points">
                <ul>
                    <li>Triedenie, čistenie a príprava stanoviska</li>
                    <li>Hrubé elektroinštalačné práce</li>
                    <li>Výstavba obvodových múrov a vnútornych priečok</li>
                    <li>Montáž okien a zárubní dvéri</li>
                    <li>Zastrešenie</li>
                </ul>
                <ul>
                    <li>Hrubé inštalatérske práce</li>
                    <li>Inštalácia rozvodov vykurovania</li>
                    <li>Tepelná izolácia múrov, strechy</li>
                    <li>Omietnutie vonkajších múrov</li>
                    <li>Ďalšie služby</li>
                </ul>
            </div>
        </div>
