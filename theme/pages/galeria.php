...
<div class="body">
    ...
    ?>
    <div class="gallery">
        <img class="dots nine" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots ten" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots eleven" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots twelve" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
                        ...
                        if (($prispevok->getObrazky()) > 0) { ?>
                            <div class="gallery-card">
                                ...
                                <a href="<?php echo BASE_URL; ?>assets/image/images/galerie/<?php echo $prispevok->getNadpis() . "_" . $prispevok->getDatumPridania("dmY_His"); ?>/<?php echo $prispevok->getNahlad(); ?>" data-fslightbox="<?php echo $prispevok->getNadpis() . "_" . $prispevok->getDatumPridania("dmY_His"); ?>">
                                    ...
                                    <?php } else { ?>
                                        <img alt="prispevok" src="<?php echo BASE_URL; ?>assets/image/images/galerie/<?php echo $prispevok->getNadpis() . "_" . $prispevok->getDatumPridania("dmY_His"); ?>/<?php echo $prispevok->getNahlad(); ?>">
                                    <?php } ?>
