<div class="body">
    ...
    <div class="our-machines">
        <img class="dots twentysix" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots twentyseven" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots twentyeight" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots twentynine" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <img class="dots thirty" src="<?php echo BASE_URL; ?>assets/image/icons/dots.svg" alt="dots">
        <h2>naše stroje</h2>
